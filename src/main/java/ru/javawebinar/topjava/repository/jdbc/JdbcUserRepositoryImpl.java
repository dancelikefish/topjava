...
public class JdbcUserRepositoryImpl implements UserRepository {
    ...
    public void insertRolesBatch(final List<Role> roles, int userId) {
    ...
    public static final class UserWithRolesExtractor implements ResultSetExtractor<List<User>> {
            ...
            while (rs.next()) {
                if (user == null || user.getId() != rs.getInt("id")) {
                    ...
                    if (user != null) {
                        ...
                        result.get(user.getId()).setRoles(roles);
                    }
                } else {
                    roles.add(Role.valueOf(rs.getString("role")));
                    result.get(user.getId()).setRoles(roles);
    ...
    private UserWithRolesExtractor userWithRolesExtractor = new UserWithRolesExtractor();
    ...
    public User save(User user) {
        ...
        insertRolesBatch(new ArrayList<>(user.getRoles()), user.getId());
        return user;
    }
